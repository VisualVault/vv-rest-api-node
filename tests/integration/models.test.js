...
describeIf(canRunIntegrationTests())('ModelsManager Integration Tests', () => {
  let config;
  let client;
  let testModelId;
  ...
  beforeAll(async () => {
    ...
    expect(testModelId).toBeTypeOf('string');
  ...
  describe('getModels', () => {
    it('should retrieve a list of models', async () => {
      ...
      const modelsResponse = await client.objectsApi.models.getModels(params);
  ...
  describe('getModelById', () => {
    it('should retrieve a model by its ID', async () => {
      expect(testModelId, 'testModelId should be set by beforeAll').toBeDefined();

      const params = {};

      const modelResponse = await client.objectsApi.models.getModelById(testModelId, params);
