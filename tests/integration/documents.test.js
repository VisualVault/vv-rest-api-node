...
const runIndexFieldTest = process.env.VV_TEST_INDEX_FOLDER_ID ? it : it.skip;
...
describeIf(canRunIntegrationTests())('DocumentsManager Integration Tests', () => {
  ...
  describe('getDocumentRevision', () => {
    ...
    it('should get document revision details', async () => {
      ...
      expect(createData.meta.status, 'Document creation should succeed').toBe(200);
  ...
  describe('putDocumentIndexFields', () => {
    ...
    runIndexFieldTest('should update document index fields', async () => {
