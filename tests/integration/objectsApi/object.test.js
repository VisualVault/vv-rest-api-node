...
const skipObjectInstanceTest = !process.env.VV_TEST_OBJECT_INSTANCE_ID;
const skipObjectModelTest = !process.env.VV_TEST_OBJECT_MODEL_ID;

describeIf(canRunIntegrationTests())('ObjectManager Integration Tests', () => {
  let config;
  let client;
  ...
  describe('getObject', () => {
    it.skipIf(skipObjectInstanceTest)('should retrieve an object instance by its ID', async () => {
    ...
    it.skipIf(skipObjectInstanceTest)('should retrieve an object instance including its related objects', async () => {
      expect(testObjectInstanceId, 'testObjectInstanceId should be set by beforeAll').toBeDefined();
  ...
  describe('getObjectsByModelId', () => {
    it.skipIf(skipObjectModelTest)('should retrieve objects by their model', async () => {
  ...
  describe('createObject / updateObject', () => {
    ...
    afterEach(async () => {
      if (instanceId) {
        try {
          await client.objectsApi.object.deleteObject(instanceId);
    ...
    it.skipIf(skipObjectModelTest)('should create and update an object', async () => {
  ...
  describe('deleteObject', () => {
    ...
    beforeEach(async () => {
      ...
      try {
        ...
        const createObjectResponse = await client.objectsApi.object.createObject(testObjectModelId, createData, createParams);
        const createObjectData = JSON.parse(createObjectResponse);
    ...
    it.skipIf(skipObjectModelTest)('should delete an object instance', async () => {
      const params = {};
