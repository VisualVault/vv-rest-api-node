...
// CustomerManager
const runCustomerAssignTest = (process.env.VV_TEST_CUSTOMER_ID && process.env.VV_TEST_CUSTOMER_USERNAME) ? it : it.skip;
...
describeIf(canRunIntegrationTests())('CustomerManager Integration Tests', () => {
  ...
  describe('assignUser', () => {
    ...
    runCustomerAssignTest('should assign a user to a customer', async () => {
