...
describeIf(canRunIntegrationTests())('DocumentInstanceManager Integration Tests', () => {
  let config;
  let client;
  let testFolderId;
  let testDocRevId;
  ...
  describe('GetRevision', () => {
    it('should return document revision details', async () => {
      ...
      const response = await client.docApi.documentInstances.GetRevision(testDocRevId);
  ...
  describe('createDocument', () => {
    ...
    it('should create a document via DocApi', async () => {
      ...
      const response = await client.docApi.documentInstances.createDocument(docData);
  ...
  describe('updateDocument', () => {
    ...
    it('should update a document via DocApi', async () => {
      ...
      const createResponse = await client.docApi.documentInstances.createDocument(createData);
      ...
      const updateResponse = await client.docApi.documentInstances.updateDocument(createdDocumentId, updateData);
  ...
  describe('getDocumentOcrStatus', () => {
    it('should return document OCR status', async () => {
      ...
      const response = await client.docApi.documentInstances.getDocumentOcrStatus(testDocRevId);
      const data = JSON.parse(response);
  ...
  describe('updateDocumentOcrStatus', () => {
    it('should update document OCR status', async () => {
      ...
      const response = await client.docApi.documentInstances.updateDocumentOcrStatus(testDocRevId, ocrUpdateRequest);
      const data = JSON.parse(response);
  ...
  describe('search', () => {
    it('should return list of documents fulfilling search criteria', async () => {
      ...
      const response = await client.docApi.documentInstances.search(
        criteriaList, 
        searchFolders, 
        excludeFolders, 
        sortBy, 
