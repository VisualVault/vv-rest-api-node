...
const runGetTest = process.env.VV_TEST_SECURITY_PARENT_ID ? it : it.skip;
const runModifyTest = (process.env.VV_TEST_SECURITY_PARENT_ID && process.env.VV_TEST_SECURITY_MEMBER_ID) ? it : it.skip;
...
describeIf(canRunIntegrationTests())('SecurityMembersManager Integration Tests', () => {
  ...
  describe('getSecurityMembersForParentId', () => {
    ...
    runGetTest('should get security members for a parent', async () => {
  ...
  describe('addSecurityMember', () => {
    ...
    runModifyTest('should add a security member', async () => {
      const parentId = config.testSecurityParentId;
  ...
  describe('updateSecurityMember', () => {
    // Requires VV_TEST_SECURITY_PARENT_ID and VV_TEST_SECURITY_MEMBER_ID
    runModifyTest('should update a security member role', async () => {
      const parentId = config.testSecurityParentId;
      const memberId = config.testSecurityMemberId;
  ...
  describe('removeSecurityMember', () => {
    // Requires VV_TEST_SECURITY_PARENT_ID and VV_TEST_SECURITY_MEMBER_ID
    runModifyTest('should remove a security member', async () => {
      const parentId = config.testSecurityParentId;
      const memberId = config.testSecurityMemberId;
