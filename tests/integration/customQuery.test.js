...
const runQueryByNameTest = process.env.VV_TEST_CUSTOM_QUERY_NAME ? it : it.skip;
const runQueryByIdTest = process.env.VV_TEST_CUSTOM_QUERY_ID ? it : it.skip;
...
describeIf(canRunIntegrationTests())('CustomQueryManager Integration Tests', () => {
  ...
  describe('getCustomQueryResultsByName', () => {
    runQueryByNameTest('should return results for a custom query by name', async () => {
  ...
  describe('getCustomQueryResultsById', () => {
    runQueryByIdTest('should return results for a custom query by ID', async () => {
