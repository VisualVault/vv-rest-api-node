...
const skipAssignTest = !(process.env.VV_TEST_CUSTOMER_DATABASE_ID && process.env.VV_TEST_CUSTOMER_DATABASE_USERNAME);
const skipRemoveTest = !(process.env.VV_TEST_CUSTOMER_DATABASE_ID && process.env.VV_TEST_CUSTOMER_DATABASE_AUTH_USER_ID);
...
describeIf(canRunIntegrationTests())('CustomerDatabaseManager Integration Tests', () => {
  ...
  describe('assignUser', () => {
    ...
    it.skipIf(skipAssignTest)('should assign a user to a database', async () => {
  ...
  describe('removeUser', () => {
    ...
    it.skipIf(skipRemoveTest)('should remove a user from a database', async () => {
      const databaseId = config.testCustomerDatabaseId;
