...
const skipPostCompletionTest = !process.env.VV_TEST_SCHEDULED_PROCESS_ID;
...
describeIf(canRunIntegrationTests())('ScheduledProcessManager Integration Tests', () => {
  ...
  describe('postCompletion', () => {
    ...
    it.skipIf(skipPostCompletionTest)('should post completion status for a scheduled process', async () => {
